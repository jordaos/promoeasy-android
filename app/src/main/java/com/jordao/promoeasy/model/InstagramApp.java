...
//import com.delaroystudios.instagramintegration.example.InstagramDialog.OAuthDialogListener;
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String username = jsonObj.getJSONObject("user").getString(
                            "username");
    ...
    public void fetchUserName(final Handler handler) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL(API_URL + "/users/" + repository.getUser().getId()
